...
const Basket: React.FC<IconProps> = ({ width = 22, height = 22, stroke = 'stroke-grey-500', strokeWidth = 2 }) => {
  return (
    <svg className={stroke} width={width} height={height} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
